    ...
    <div className="p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={startCreate}
            className="flex items-center gap-2 px-4 py-2.5 bg-navy-600 text-white text-sm font-medium rounded-lg hover:bg-navy-700 transition-colors btn-press"
          >
            <Plus size={16} />
            New Code
          </button>
        ...
        <div className="mb-6 bg-white rounded-xl border border-warm-100 card-shadow p-5">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 text-sm border border-warm-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-navy-300"
            />
            <button
              onClick={() => {
              ...
              className="px-3 py-1.5 bg-navy-600 text-white text-sm rounded-lg hover:bg-navy-700 disabled:opacity-40 transition-colors"
            >
              Add
            </button>
          </div>
        ...
        <div className="mb-6 bg-white rounded-xl border border-warm-100 card-shadow p-5">
          ...
          <div className="flex gap-2 mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-navy-600 text-white text-sm rounded-lg hover:bg-navy-700 disabled:opacity-40 transition-colors"
            >
              <Save size={14} />
              Save Current
            </button>
                ...
                <div key={t.id} className="flex items-center justify-between border border-warm-100 rounded-lg px-3 py-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-xs text-navy-600 hover:text-navy-700 font-medium px-2 py-1"
                    >
                      Apply
                    </button>
                    <button
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-warm-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-navy-300 focus:border-navy-400"
                  autoFocus
                />
              </div>
                    ...
                    return (
                      <button
                        ...
                        className={`w-7 h-7 rounded-full ${cc.dot} transition-all ${
                          formColor === c ? 'ring-2 ring-offset-2 ring-navy-400 scale-110' : 'hover:scale-110'
                        }`}
                        title={c}
                      />
                    );
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-warm-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-navy-300 focus:border-navy-400 bg-white"
                >
              ...
              <div className="flex gap-2 pt-2">
                <button
                  ...
                  className="flex-1 py-2 bg-navy-600 text-white text-sm font-medium rounded-lg hover:bg-navy-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors btn-press"
                >
