        ...
        <div className="mb-6 bg-white rounded-xl border border-warm-100 card-shadow p-5">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 text-sm border border-warm-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-forest-300"
            />
            <button
              onClick={() => {
              ...
              className="px-3 py-1.5 bg-forest-500 text-white text-sm rounded-lg hover:bg-forest-600 disabled:opacity-40 transition-colors"
            >
              Add
            </button>
          </div>
        ...
        <div className="mb-6 bg-white rounded-xl border border-warm-100 card-shadow p-5">
          ...
          <div className="flex gap-2 mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-forest-500 text-white text-sm rounded-lg hover:bg-forest-600 disabled:opacity-40 transition-colors"
            >
              <Save size={14} />
              Save Current
            </button>
                ...
                <div key={t.id} className="flex items-center justify-between border border-warm-100 rounded-lg px-3 py-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-xs text-forest-600 hover:text-forest-700 font-medium px-2 py-1"
                    >
                      Apply
                    </button>
                    <button
