    ...
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full border border-warm-200 rounded-xl pl-10 pr-4 py-3 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-navy-300 focus:border-navy-400"
          autoFocus
        />
      </div>
