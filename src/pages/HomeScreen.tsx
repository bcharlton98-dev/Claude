...
import { FireIcon, MapIcon, StarIcon, ChevronRightIcon } from '@heroicons/react/24/solid'
    ...
    <div className="flex flex-col min-h-[calc(100vh-80px)]">
        ...
        <div className="flex items-center justify-between w-full mb-6">
          ...
          <div className="flex items-center gap-2">
            <span className="flex items-center gap-1 bg-white/15 text-white px-2.5 py-1 rounded-full text-xs font-bold">
              <FireIcon className="w-3.5 h-3.5 text-ember-300" /> {userProfile.streak}
            </span>
            <span className="flex items-center gap-1 bg-white/15 text-white px-2.5 py-1 rounded-full text-xs font-bold">
              💎 {userProfile.gems}
            </span>
      ...
      <div className="px-1 -mt-4 relative z-10">
        <div className="flex gap-2">
          ...
          >
            <StarIcon className={`w-4 h-4 ${atHealthZone ? 'text-olive-400' : 'text-warm-300'}`} />
      ...
      <div className="mt-5 flex-1">
        {competitiveNotif ? (
          ...
          <div className="bg-olive-50 rounded-2xl p-4 flex items-center gap-3 card-shadow border border-olive-200">
            ...
            <ChevronRightIcon className="w-5 h-5 text-warm-300 shrink-0" />
          </div>
        ) : (
          /* Streak nudge — amber */
        ...
        >
          See friends leaderboard <ChevronRightIcon className="w-3 h-3" />
        </button>
      </div>
