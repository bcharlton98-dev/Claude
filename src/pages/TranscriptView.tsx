  ...
  if (!transcript) {
    return (
      <div className="p-8">
        ...
        <Link to="/transcripts" className="text-indigo-600 hover:underline text-sm mt-2 inline-block">
          Back to transcripts
        </Link>
      </div>
    );
  ...
  return (
    <div className="flex h-screen">
      <div className="flex-1 overflow-y-auto p-8">
        <Link
          to="/transcripts"
          className="inline-flex items-center gap-1.5 text-sm text-warm-500 hover:text-indigo-600 mb-4"
        >
          <ArrowLeft size={14} />
          Back
        </Link>
        ...
        {isEditing ? (
          <div className="flex items-center gap-2 mb-4">
            <input
              ...
              className="text-2xl font-bold text-warm-800 border border-warm-200 rounded-lg px-2 py-1 flex-1 focus:outline-none focus:ring-2 focus:ring-indigo-300"
              autoFocus
            />
            <button onClick={saveTitle} className="text-sm text-indigo-600 font-medium px-3 py-1">Save</button>
          </div>
        ) : (
          <h1
            className="text-2xl font-bold text-warm-800 mb-2 cursor-pointer hover:text-indigo-700 transition-colors"
        ...
        <div className="flex items-center gap-2 flex-wrap mb-6">
          ...
          <div className="inline-flex">
            <input
              ...
              placeholder="+ tag"
              className="w-20 text-xs border border-warm-200 rounded-lg px-2 py-1 focus:outline-none focus:ring-1 focus:ring-indigo-300 focus:w-32 transition-all"
      ...
      <aside className="w-80 border-l border-warm-200 bg-white overflow-y-auto p-5 shrink-0">
        ...
        <div className="mb-5">
          ...
          <input
            ...
            className="w-full text-sm border border-warm-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-400"
                ...
                return (
                  <div key={key}>
                    ...
                    <input
                      ...
                      className="w-full text-sm border border-warm-200 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-1 focus:ring-indigo-300"
                    />
                  </div>
                );
              })}
